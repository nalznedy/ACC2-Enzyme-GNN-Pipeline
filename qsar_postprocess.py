#!/usr/bin/env python3
"""
Script: qsar_postprocess.py

Purpose:
    Post-process extracted ChEMBL activity tables into pIC50-based modeling tables.

Workflow step:
    Utility pre-step before Script 00 when pIC50 and activity labels are generated from raw assay values.

Main inputs:
    - Extracted ChEMBL CSV (raw or qsar_ready)

Main outputs:
    - Processed CSV tables with pIC50 and Active labels
    - figures/active_inactive_counts.svg|png
    - figures/property_radar.svg|png
    - figures/mw_logp_bubble.svg|png

Notes:
    Supports unit normalization, record aggregation, and optional use of pchembl_value.
"""
